...
//     final storedPass = mockLoginCredentials[mobile.trim()];
//     if (storedPass != null && storedPass == password) {
//       _currentClient = mockClients[mobile.trim()];
//       _alerts = getMockAlerts(_currentClient!);
//       _isLoading = false;
//       notifyListeners();
//       return true;
...
//     _error = 'Invalid mobile number or password. Contact your administrator.';
//     _isLoading = false;
//     notifyListeners();
//     return false;
//   }
...
class AuthState extends ChangeNotifier {
  ...
  Future<bool> login(String mobile, String password) async {
    ...
    final key = mobile.trim();
    final storedPass = mockLoginCredentials[key];
    final client = mockClients[key];

    if (storedPass != null && storedPass == password && client != null) {
      _currentClient = client;
      _alerts = getMockAlerts(_currentClient!);
      _isLoading = false;
      notifyListeners();
